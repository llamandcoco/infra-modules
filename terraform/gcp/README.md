...
| <a name="input_logging_config"></a> [logging\_config](#input\_logging\_config) | Logging configuration for the bucket. If not specified, logging is disabled. | <pre>object({<br/>    log_bucket        = string<br/>    log_object_prefix = optional(string, "")<br/>  })</pre> | `null` | no |
