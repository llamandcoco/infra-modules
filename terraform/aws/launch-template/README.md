...
|------|-------------|------|---------|:--------:|
| <a name="input_ami_architecture"></a> [ami\_architecture](#input\_ami\_architecture) | AMI architecture for AL2023 SSM lookup: auto (infer from instance\_type), x86\_64, or arm64 | `string` | `"auto"` | no |
| <a name="input_ami_ssm_parameter_name"></a> [ami\_ssm\_parameter\_name](#input\_ami\_ssm\_parameter\_name) | Optional custom SSM parameter name for AL2023 AMI lookup | `string` | `null` | no |
