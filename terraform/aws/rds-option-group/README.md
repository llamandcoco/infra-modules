...
- **Multiple DB Engines** - Support for MySQL, MariaDB, Oracle, and SQL Server
...
| <a name="input_engine_name"></a> [engine\_name](#input\_engine\_name) | Database engine name (e.g., mysql, mariadb, oracle-ee, oracle-se2, sqlserver-ee, sqlserver-se, sqlserver-ex, sqlserver-web). | `string` | n/a | yes |
