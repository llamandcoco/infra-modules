...
module "test_lb_controller_role" {
  source = "../../"

  role_name         = "test-lb-controller"
...
output "role_arn" {
  ...
  value       = module.test_lb_controller_role.role_arn
}

output "role_name" {
  description = "Name of the AWS Load Balancer Controller IAM role"
  value       = module.test_lb_controller_role.role_name
}

output "policy_arn" {
  description = "ARN of the AWS Load Balancer Controller IAM policy"
  value       = module.test_lb_controller_role.policy_arn
}
