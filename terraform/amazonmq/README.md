...
- **Configuration Attachment:** Attach existing AmazonMQ configuration resources created by external modules
...
Configuration creation is intentionally handled outside this module.
...
| <a name="input_configuration_id"></a> [configuration\_id](#input\_configuration\_id) | ID of an existing AmazonMQ configuration to attach to this broker.<br/><br/>This module does not create configurations. Create them in a separate module<br/>and pass the resulting ID and revision here. | `string` | `null` | no |
| <a name="input_configuration_revision"></a> [configuration\_revision](#input\_configuration\_revision) | Revision number for the attached AmazonMQ configuration.<br/><br/>Must be provided together with configuration\_id. | `number` | `null` | no |
...
| <a name="input_maintenance_day_of_week"></a> [maintenance\_day\_of\_week](#input\_maintenance\_day\_of\_week) | Day of the week for maintenance window.<br/><br/>Valid values: MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY<br/><br/>Default is SUNDAY. | `string` | `"SUNDAY"` | no |
...
| <a name="output_configuration_id"></a> [configuration\_id](#output\_configuration\_id) | ID of the externally managed configuration attached to this broker. Returns null when no configuration is attached. |
| <a name="output_configuration_revision"></a> [configuration\_revision](#output\_configuration\_revision) | Revision of the externally managed configuration attached to this broker. Returns null when no configuration is attached. |
